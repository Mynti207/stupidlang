...
if on_rtd:
    ...
    module_dir = os.path.join(__location__, "../Mynti207")
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx',
              ...
              'sphinx.ext.pngmath', 'sphinx.ext.napoleon']
...
try:
    from Mynti207 import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'Mynti207-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'Mynti207 Documentation',
   u'Gioia Dominedo', 'manual'),
]
